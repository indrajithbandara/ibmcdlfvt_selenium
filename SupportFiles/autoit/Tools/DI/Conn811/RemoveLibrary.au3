...
if WinWaitActive($LOTUSQUICKROld,$DeleteText_EN,$ResponseTime)=0 Then
	MsgBox(1, $LOTUSQUICKROld, $DeleteText_EN)
	Return GetReturnStr($Failed,"No dialog for ensuring removal of place appears");$NoAddPlaceAppear
EndIf
ControlClick($LOTUSQUICKROld,$DeleteText_EN,'Button1')
While WinWaitActive($LOTUSQUICKROld,$DeleteLibText_EN,$ResponseTime/10) ;delete the content of the given libraries
	ControlClick($LOTUSQUICKROld,$DeleteLibText_EN,"Button1")
	;Sleep(1000)
WEnd

...
;OpenPlaceFile("PPT_BVT_DI_4.ppt","Lotus Quickr\BVT_1207549311687 on lwptsthink26")
...
Func openApp()
	...
	If not WinExists($pptTitle) Then
		ConsoleWrite("Failed")
	EndIf

	WinSetState ($pptTitle, "", @SW_MAXIMIZE)
	WinActivate($pptTitle) 

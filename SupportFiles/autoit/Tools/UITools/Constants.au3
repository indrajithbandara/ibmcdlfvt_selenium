...
Global Const $addPlaceTitle="Add Places to Lotus Quickr connectors"
...
Global Const $DeleteLibText_EN="delete the contents"; used for delete the content of library

...
public class GUAT_EditorIconCheck extends TestCase {
	...
	public GUAT_EditorIconCheck() {

		super.setName("testMain_UAT_EditorIconCheck");
	...
	public void testMain_UAT_EditorIconCheck() throws Exception{
    	...
    	try{
			...
			task.qfd_CreatePlaceTask.createPlace("UAT_EditorIcon" + Datefuncs.genDateBasedRandVal(), null);
			
			task.qfd_LibraryTask.verifyEditorIcons();

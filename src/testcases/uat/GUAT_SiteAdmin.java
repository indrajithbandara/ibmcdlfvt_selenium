...
public class GUAT_SiteAdmin extends TestCase {
	...
	public GUAT_SiteAdmin() {

		super.setName("testMain_UAT_SiteAdmin");
	...
	public void testMain_UAT_SiteAdmin() throws Exception{

    	init();
    	
    	try{
    		
    		task.qfd_AdminTask.verifySiteBasic(user.AdminName, user.AdminPW, user.LDAPName);

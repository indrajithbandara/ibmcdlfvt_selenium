...
public class GUAT_PlacesList extends TestCase {
	...
	public GUAT_PlacesList() {

		super.setName("testMain_UAT_PlacesList");
	...
	public void testMain_UAT_PlacesList() throws Exception{
    	...
    	try{
    		...
    		task.qfd_CreatePlaceTask.create2Blogs("adminBlog" + Datefuncs.genDateBasedRandVal(), null);
    		
    		task.qfd_LoginTask.logIn(user.AdminName, user.AdminPW);
    		task.qfd_AdminTask.verifyPlacesList();

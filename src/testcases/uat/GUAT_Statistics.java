...
public class GUAT_Statistics extends TestCase {
	...
	public GUAT_Statistics() {

		super.setName("testMain_UAT_Statistics");
	...
	public void testMain_UAT_Statistics() throws Exception{
    	...
    	try{
    		...
    		task.qfd_AdminTask.downloadStatistics();
